...
@injectable()
export default class GetAllSellerPendenteFromASupervisorService {
  constructor(
  ...
  public async execute(supervisorId: string): Promise<Seller[] | null> {
    ...
    const seller = await this.sellerRepository.getAllSellerPendenteFromASupervisor(supervisorId);
